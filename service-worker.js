import { config } from "./package_87ce43fcd5e2ad771c53d7cf04514cfeb225f94a/uno-config.js";
...
if (config.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('package_87ce43fcd5e2ad771c53d7cf04514cfeb225f94a').then(async function (cache) {
